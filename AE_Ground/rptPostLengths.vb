...
Public Class rptPostLengths
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AE_Ground.rptPostLengths.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPostLengths
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPostLengths = New rptPostLengths
        rpt.Site = Me.Site
        Return rpt
    End Function
