...
Public Class rptPostLength6x8
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AE_Ground.rptPostLength6x8.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPostLength6x8
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPostLength6x8 = New rptPostLength6x8
        rpt.Site = Me.Site
        Return rpt
    End Function
