...
Public Class rptNPIxmlData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AE_Ground.rptNPIxmlData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNPIxmlData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNPIxmlData = New rptNPIxmlData
        rpt.Site = Me.Site
        Return rpt
    End Function
