...
Public Class rptPostLengths4x6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AE_Ground.rptPostLengths4x6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPostLengths4x6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPostLengths4x6 = New rptPostLengths4x6
        rpt.Site = Me.Site
        Return rpt
    End Function
